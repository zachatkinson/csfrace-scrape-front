...
test.describe("Integration Tests @integration", () => {
  ...
  test("should connect frontend to backend API @integration", async ({
    page,
  }) => {
  ...
  test("should handle API authentication flow @integration", async ({
    page,
  }) => {
  ...
  test("should validate system info endpoint @integration", async ({
    page,
  }) => {
  ...
  test("should handle scraping API endpoints @integration", async ({
    page,
  }) => {

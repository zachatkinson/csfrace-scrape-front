      ...
      <div className="relative w-full max-w-md mx-4">
        <div className="liquid-glass rounded-glass p-6 border border-white/20 relative">
          ...
          <div className="mb-6">
            ...
            <p className="text-white/70 text-sm mt-1">Sign in securely with modern authentication</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              {[
                { name: 'Google', provider: 'google', bgColor: 'bg-white hover:bg-gray-100', textColor: 'text-gray-800' },
                { name: 'GitHub', provider: 'github', bgColor: 'bg-gray-900 hover:bg-gray-800', textColor: 'text-white' },
                { name: 'Microsoft', provider: 'microsoft', bgColor: 'bg-blue-600 hover:bg-blue-700', textColor: 'text-white' },

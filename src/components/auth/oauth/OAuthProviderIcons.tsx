 ...
 * Single Responsibility: Manages SVG icons for OAuth providers
 * Open/Closed: Easy to add new provider icons without modifying existing code
 */
 ...
 * Multi-colored Google brand SVG
 */
...
/**
 * GitHub OAuth Icon Component
 * Monochrome GitHub Octocat logo
 */
...
/**
 * Microsoft OAuth Icon Component
...
/**
 * Facebook OAuth Icon Component
 * Facebook 'f' logo in circle
 */
 ...
 * Factory Pattern: Creates icons based on provider ID
 * Open/Closed: Easy to extend with new providers
 */
export const createProviderIcon = (providerId: OAuthProviderId, className?: string) => {
  const iconMap: Record<OAuthProviderId, React.FC<IconProps>> = {
    google: GoogleIcon,
    github: GitHubIcon,

      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            {validationMessage && (
              <div className={`mt-2 text-xs ${hasValidationError ? 'text-red-400' : 'text-green-400'}`}>
                {validationMessage}
              </div>
            )}
          </div>
          ...
          <div>
            ...
            >
              <div className="text-center">
                <svg className="mx-auto h-8 w-8 text-white/60" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                  <path 
        ...
        {/* Processing Options */}
        <div className="liquid-glass rounded-glass p-4">
          <h3 className="text-sm font-medium text-white/80 mb-3">Processing Options</h3>
        ...
        <div className="text-xs text-white/50 space-y-1">
          ...
          <div>• Supported formats: Plain text (one URL per line), CSV, JSON</div>
          <div>• Batch processing runs all URLs simultaneously for faster results</div>
        </div>
      </div>
    </LiquidCard>
  );

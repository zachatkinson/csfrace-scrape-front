          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                value={sortBy}
                onChange={(e) =>
                  setSortBy(e.target.value as "newest" | "oldest" | "progress")
                }
                className="liquid-glass px-3 py-1 rounded-glass text-sm text-white bg-transparent border border-white/20 focus:border-blue-500/50"
              >
        ...
        {filteredAndSortedJobs.length === 0 ? (
          <LiquidCard className="text-center py-12">
            <div className="text-white/60">
              ...
              <p className="text-sm">
                Start by submitting a WordPress URL for conversion
              </p>
            </div>
          </LiquidCard>
        ) : (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-shrink-0 mt-1">
                    <div
                      className={`w-5 h-5 rounded border-2 transition-all duration-glass ${
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        >
                          {(() => {
                            const behavior = JobStatusManager.getBehavior(
                              job.status,
                            );
                            const actions = [];
                                ...
                                >
                                  ...
                                  >
                                    <path
                                      ...
                                      strokeLinejoin="round"
                                      strokeWidth={2}
                                      d="M12 10v6m0 0l-4-4m4 4l4-4m-6 2a9 9 0 11-18 0 9 9 0 0118 0z"
                                    />
                                  </svg>
                                </button>,
                              );

                      ...
                      {oauthProviders.map((provider) => (
                        <button
                          ...
                          className={`glass-button px-4 py-2 flex items-center gap-2 text-sm font-medium transition-colors
                            ${provider === 'google' ? 'text-red-300 hover:text-red-200 hover:bg-red-500/20' : ''}
                            ${provider === 'github' ? 'text-gray-300 hover:text-gray-200 hover:bg-gray-500/20' : ''}
                            ${provider === 'microsoft' ? 'text-blue-300 hover:text-blue-200 hover:bg-blue-500/20' : ''}
                          `}
                        >

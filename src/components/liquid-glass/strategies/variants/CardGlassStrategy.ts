...
export class CardGlassStrategy extends BaseGlassVariantStrategy {
  constructor() {
    super('card', 'Enhanced glass effect optimized for card containers with improved depth');
  }
  ...
  getConfig(props: GlassVariantProps): GlassVariantConfig {
    return {
      ...
      interactiveClasses: [
        ...
        ...(props.interactive ? ['hover:shadow-glass-card-hover', 'transition-glass-card'] : []),
      ],
      adaptiveClasses: [

...
export class GamingGlassStrategy extends BaseGlassVariantStrategy {
  constructor() {
    super(
      "gaming",
      "High-performance glass effect optimized for gaming interfaces with RGB accents",
    );
  }
  ...
  getConfig(props: GlassVariantProps): GlassVariantConfig {
    return {
      ...
      customProperties: {
        ...
        "--glass-gaming-border":
          "linear-gradient(45deg, #00ff7f, #ff1493, #00bfff)",
      ...
      interactiveClasses: [
        ...
        ...(props.interactive
          ? ["hover:shadow-gaming-intense", "active:scale-gaming"]
          : []),
      ],
      adaptiveClasses: [
  ...
  getConfig(props: GlassVariantProps): GlassVariantConfig {
    return {
      ...
      interactiveClasses: [
        ...this.getInteractiveClasses(props.interactive),
        ...(props.interactive
          ? ["hover:shadow-neon-intense", "cursor-neon"]
          : []),
      ],
      adaptiveClasses: [
        ...this.getAdaptiveClasses(props.adaptive),

...
class FilterManager implements IFilterManager { /* ... */ }
class MockFilterManager implements IFilterManager { /* ... */ } // ✅ Substitutable
class ReduxFilterManager implements IFilterManager { /* ... */ } // ✅ Substitutable
```
...
class TestDOMUtils implements IDOMUtils { /* ... */ } // ✅ For testing
class ReactDOMUtils implements IDOMUtils { /* ... */ } // ✅ For React integration
```
...
interface IFilterManager { /* only filter methods */ }
interface ISearchManager { /* only search methods */ }  
interface ISortManager { /* only sort methods */ }
interface IBatchActionManager { /* only batch methods */ }

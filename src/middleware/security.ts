...
export class SecurityMiddleware {
  ...
  private static applySecurityHeaders(response: Response): void {
    ...
    headers.set('Content-Security-Policy', this.SECURITY_HEADERS.contentSecurityPolicy);
    
    // X-Frame-Options
    headers.set('X-Frame-Options', this.SECURITY_HEADERS.frameOptions);
    
    // X-Content-Type-Options
    headers.set('X-Content-Type-Options', this.SECURITY_HEADERS.contentTypeOptions);
    ...
    if (import.meta.env.PROD) {
      headers.set('Strict-Transport-Security', this.SECURITY_HEADERS.strictTransportSecurity);
    }

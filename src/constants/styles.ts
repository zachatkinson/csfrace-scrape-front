...
export const BASE_STYLES = {
  ...
  GLASS_BUTTON:
    "bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-200",
  GLASS_INPUT:
    "bg-white/5 backdrop-blur-md border border-white/10 focus:border-white/30 rounded-lg",
...
export const BUTTON_STYLES = {
  ...
  // Secondary buttons
  SECONDARY:
    "bg-transparent border border-white/20 text-white/90 hover:text-white px-6 py-2 rounded-lg transition-all duration-200",
  SECONDARY_SMALL:
    "bg-transparent border border-white/20 text-white/90 hover:text-white px-3 py-1 rounded text-xs transition-all duration-200",
...
export const PROGRESS_STYLES = {
  ...
  BAR_GRADIENT:
    "bg-gradient-to-r from-blue-400 to-blue-600 h-2 rounded-full transition-all duration-1000",
  BAR_SUCCESS:
    "bg-gradient-to-r from-green-400 to-green-600 h-2 rounded-full transition-all duration-1000",
  BAR_WARNING:
    "bg-gradient-to-r from-yellow-400 to-yellow-600 h-2 rounded-full transition-all duration-1000",
  BAR_ERROR:
    "bg-gradient-to-r from-red-400 to-red-600 h-2 rounded-full transition-all duration-1000",

  // Loading spinners
  SPINNER: "animate-spin rounded-full border-2 border-white/20 border-t-white",
  SPINNER_SMALL:
    "w-4 h-4 animate-spin rounded-full border-2 border-white/20 border-t-white",
  SPINNER_MEDIUM:
    "w-6 h-6 animate-spin rounded-full border-2 border-white/20 border-t-white",
  SPINNER_LARGE:
    "w-8 h-8 animate-spin rounded-full border-2 border-white/20 border-t-white",

  // Status indicators
  DOT_PENDING: "w-3 h-3 bg-gray-400 rounded-full",
  DOT_PROCESSING:
    "animate-spin rounded-full w-3 h-3 border-2 border-blue-400/30 border-t-blue-400",
...
export const FORM_STYLES = {
  ...
  LABEL_REQUIRED:
    'block text-white/70 text-sm mb-2 font-medium after:content-["*"] after:text-red-400 after:ml-1',

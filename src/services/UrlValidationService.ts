...
export const isValidUrl = UrlValidationService.isValidUrl.bind(UrlValidationService);
export const normalizeUrl = UrlValidationService.normalizeUrl.bind(UrlValidationService);
export const extractDomain = UrlValidationService.extractDomain.bind(UrlValidationService);
export const isShopifyUrl = UrlValidationService.isShopifyUrl.bind(UrlValidationService);
export const isWordPressUrl = UrlValidationService.isWordPressUrl.bind(UrlValidationService);
export const validateBatch = UrlValidationService.validateBatch.bind(UrlValidationService);
export const getValidationError = UrlValidationService.getValidationError.bind(UrlValidationService);
export const parseUrlsFromText = UrlValidationService.parseUrlsFromText.bind(UrlValidationService);
export const isReachable = UrlValidationService.isReachable.bind(UrlValidationService);